...
### Configuration
  ...
  * EXCHANGE
    ...
    6. `bitstamp` - Websocket market data and REST order API. Ensure the Bitstamp-specific properties have been set with your correct account information. Production environment only.
